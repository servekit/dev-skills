...
type RemoteServiceConfig[T any] struct {
	// Mode is "grpc" or "module". "module" is the dev default — in-process.
...
// env. Env vars under $DEMO_SERVICE_ also override file values via
